...
your_odds('flop', c('Ks', 'Kc', 'Kd', 'Kh', 'Qs', 'Qc', 'Qd', 'Ad', 'Ac', 'Ah'), c('Ks', 'Qs', 'Ts', '9s', '8s', '7s', '6s', '5s', '4s', '3s', '2s'))
...
Slansky-Chubukov Numbers

```{r}

hands_sc <- read.csv('slansky_chubukov.csv')

slansky_num <- function(your_hand, big_blind) {
  hands <- hands_sc$hand
  ...
  return(paste('Move All-In with less than $', move_in_num))
}
